        ...
        for query in data_list:
            ...
            if "images" in raw_data:
                ...
                if isinstance(raw_data["images"], list):
                    image_paths = [item[0] for item in raw_data["images"]]
                    raw_data["images"] = self.processor.image_processor(image_paths)
...
class VisualglmCollator:
    ...
    def __init__(self, processor, mode="test", intokens=False, max_seq_length=2048):
        self.processor = processor
        self.mode = mode
